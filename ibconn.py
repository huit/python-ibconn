...
class InfobloxConn:
    ...
    def get_fixedaddress (self, keyfield, key, numresults=100, fields=self.ib_fixedaddr_fields):
    ...
    def get_lease (self, keyfield, key, numresults=100, fields=self.ib_lease_fields):
    ...
    def get_macfilteraddress (self, keyfield, key, numresults=100, fields=self.ib_macfilteraddress_fields):
    ...
    def get_zone_auth (self, keyfield, key, fields=self.ib_zone_auth_fields):
    ...
    def get_zone_delegated (self, keyfield, key, fields=self.ib_zone_delegated_fields):
